...
<html>
    ...
    <body>
        ...
        <table border="1" class="tutturu">
            ...
            %>
            <tr>
                <td><% if(ij.get(i).getPaket_nama() !=null) out.print(ij.get(i).getPaket_nama()); else out.print("-"); %></td>
                <td><% if(ij.get(i).getDescription() !=null) out.print(ij.get(i).getDescription()); else out.print("-"); %></td>
                <td><% if(ij.get(i).getTotal_price() !=0) out.print(ij.get(i).getTotal_price()); else out.print("0"); %></td>
                <td><% if(ij.get(i).getNadult() !=0) out.print(ij.get(i).getNadult()); else out.print("0"); %></td>
                <td><% if(ij.get(i).getNchild() !=0) out.print(ij.get(i).getNchild()); else out.print("0"); %></td>
                <td><% if(ij.get(i).getTime() !=null) out.print(ij.get(i).getTime()); else out.print("-"); %></td>
